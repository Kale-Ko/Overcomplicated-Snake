...
CPP_DEBUG_OPTIONS=${DEBUG_OPTIONS} ${CPP_OPTIONS} -D SNAKE_DEBUG_INPUT
# Linker options
...
# main.cpp
build/main.o: src/main.cpp src/game.hpp src/window.hpp src/windowevents.hpp src/keyboard.hpp
	@ mkdir -p build/
	${COMPILER} -c src/main.cpp -o build/main.o ${CPP_RELEASE_OPTIONS}
build/main-debug.o: src/main.cpp src/game.hpp src/window.hpp src/windowevents.hpp src/keyboard.hpp
	@ mkdir -p build/
	${COMPILER} -c src/main.cpp -o build/main-debug.o ${CPP_DEBUG_OPTIONS}

# game.cpp
build/game.o: src/game.cpp src/game.hpp src/windowevents.hpp src/keyboard.hpp
	@ mkdir -p build/
	${COMPILER} -c src/game.cpp -o build/game.o ${CPP_RELEASE_OPTIONS}
build/game-debug.o: src/game.cpp src/game.hpp src/windowevents.hpp src/keyboard.hpp
	@ mkdir -p build/
...
# Lint
lint:
	${LINTER} src/*.hpp src/*.cpp -- ${CPP_RELEASE_OPTIONS}
